                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion" style="">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="admin/userlist.do">회원목록</a>
                                    <a class="nav-link" href="admin/withdrawal.do">탈퇴회원목록</a>
                                    <a class="nav-link" href="admin/blacklist.do">블랙리스트목록</a> 
                                    <a class="nav-link" href="admin/createAdmin.do">관리자생성</a>
                                    <a class="nav-link" href="admin/adminlist.do">관리자목록</a> 
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseone" aria-labelledby="headingOne" data-parent="#sidenavAccordion" style="">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="admin/dailycoin.do">일별코인충전</a>
                                    <a class="nav-link" href="admin/monthlycoin.do">월별코인충전</a>  
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsetwo" aria-labelledby="headingOne" data-parent="#sidenavAccordion" style="">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="admin/dailysales.do">일일방문현황</a> 
                                    <a class="nav-link" href="admin/monthlysales.do">월별방문현황</a> 
                                </nav>
                            </div>
                             ...
                             <div class="collapse" id="collapsethree" aria-labelledby="headingOne" data-parent="#sidenavAccordion" style="">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="admin/salesarticlelist.do">판매글</a>
                                    <a class="nav-link" href="admin/userinquiry.do">고객문의</a>
                                    <a class="nav-link" href="admin/carnews.do">자동차뉴스</a>
                                    <a class="nav-link" href="admin/purchasereview.do">구매후기</a>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row"> 
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin/salesarticlelist.do">자세히 보기</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin/userinquiry.do">자세히 보기</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin/carnews.do">자세히 보기</a> 
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin/purchasereview.do">자세히 보기</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
