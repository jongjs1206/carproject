...
<link rel="stylesheet" href="../resources/css/user/declaration.css"	type="text/css">
<link rel="stylesheet" href="../resources/css/admin/admin.css"	type="text/css">
...
<body style="margin: 0px; padding: 0px;"">
	...
	<div class="container note_content">
		...
		<a href="member_status.do?id=${report.m_id}"><button class='btn_send'>피신고자 정보</button></a>
		<button id="exit" class='btn_send'>확인</button>
	</div>
