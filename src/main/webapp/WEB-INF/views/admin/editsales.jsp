                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputEmail3">판매자 ID</label>
                        ...
                        <div class="form-group col-md-3"></div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">이미지</label>
                            <input type="password" class="form-control" id="inputPassword" placeholder="이미지"> 
                        </div>
                        <div class="form-group col-md-3"></div>
                        ...
                        <div class="form-group col-md-3">
                            <label for="inputPassword4">성</label>
                            <input type="성" class="form-control" id="lastname"
                                placeholder="홍">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputPassword4">이름</label>
                            <input type="이름" class="form-control" id="firstname"
                                placeholder="길동">
                        </div>
                        <div class="form-group col-md-3"></div>                                
                        ...
                        <div class="form-group col-md-2">
                          <input type="button" class="btn btn-primary" onclick="location.href='userlist.do'" value="수정하기">
                        </div>                                                
                    </div>
