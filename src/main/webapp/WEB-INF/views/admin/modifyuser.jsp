            ...
            <main>
                <form>
                    <div class="form-group row">
                        ...
                        <div class="form-group col-md-2">  
                          <input type="button" class="btn btn-primary" onclick="location.href='withdrawal.do'" value="탈퇴하기"> 
                        </div> 
                         <div class="form-group col-md-2">   
                          <input type="button" class="btn btn-primary" onclick="location.href='userlist.do'" value="블랙리스트추가">
                        </div>                                                                     
                    </div>
