...
<body>
	...
	<form>
		<div class="container">
				...
				<div class="col-lg-5">	<!-- start of 오른쪽 위 -->
	            	<div class="course__details__sidebar">
	                	...
	                	<c:forEach var="sales" items="${sales}">
	                        ...
	                        <div class="carInfo"><h6 style="text-align:center">${sales.carYear} | ${sales.km}km | ${sales.carFuel}</h6></div>
	                        ...
	                        <div class="salesManInfo">
	                        	...
	                        	<c:forEach var="sales" items="${sales}">
				           			...
				           			<div class="salesMan"><br/><br/>
				           				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>${sessionScope.info.m_name}(${sessionScope.info.m_id})</span><br/>
					           			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>${sessionScope.info.tel}</span>
				                	</div>
				                </c:forEach>
				           		</div> 
				            </div>
			...
			<div class="modifyBtn" style="margin:50px 0;">
		    	<a href="../user/sales.do"><span style="margin-left:500px;">수정하기</span></a>
		    </div>
			
			<!-- <div class="col-lg-16 text-center">	버튼 대신 다른 방법으로!!
				<a href="../user/sales.do">
